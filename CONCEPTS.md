...
### Search Source
The unified user-facing representation of a configured AI provider, a conventional Search Engine, a Site Engine, or a Custom Engine, allowing the same source controls to present all four despite their different execution contracts.
