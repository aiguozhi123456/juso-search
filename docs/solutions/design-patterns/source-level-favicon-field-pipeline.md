...
web_accessible_resources: [{
  resources: [
    // 示例节选——实际列表更长：全部引擎图标（含 bilibili/yandex/duckduckgo/site.svg 等）与全部 provider 图标。
    'icons/google.svg', 'icons/bing.svg', 'icons/baidu.svg', 'icons/bilibili.svg',
    'icons/yandex.svg', 'icons/duckduckgo.svg', 'icons/site.svg', /* ...engines... */
    'icons/tavily.svg', 'icons/exa.svg', 'icons/brave.svg', 'icons/stepfun.svg',
    'icons/jina.svg', 'icons/doubao.svg', 'icons/doubao-global.svg', // providers
  ],
