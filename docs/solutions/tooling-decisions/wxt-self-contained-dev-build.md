...
- [Chrome & Firefox Extension Release Process](../workflow-issues/chrome-extension-release-process.md) — 完整的发布流程（版本升级、Chrome 双版本构建 + Firefox ZIP、标签、GitHub Release、CWS 提交）
