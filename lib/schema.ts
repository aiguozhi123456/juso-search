// Schema 版本与迁移：config 域（providerKeys / activeProvider / themePref / localePref）。
//
...
export const CONFIG_KEYS = ['providerKeys', 'activeProvider', 'themePref', 'localePref'] as const;
