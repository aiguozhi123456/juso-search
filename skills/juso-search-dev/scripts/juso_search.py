...
DEFAULT_BRIDGE_URL = "chrome-extension://pdklefhommhabbhkglgkgomeibeibmcl/bridge.html"
...
def run(args: argparse.Namespace) -> tuple[int, Any]:
    ...
    # Pass bridge_url only if it's a real URL (not the unstamped "chrome-extension://pdklefhommhabbhkglgkgomeibeibmcl/bridge.html" placeholder).
