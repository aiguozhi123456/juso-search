...
describe('buildExportPayload', () => {
  ...
  it('exports a normalized complete source order', async () => {
    ...
    await expect(buildExportPayload()).resolves.toMatchObject({
      sourceOrder: ['bing', 'exa', 'tavily', 'brave', 'stepfun', 'stepfun-plan', 'jina', 'doubao', 'doubao-global', 'parallel', 'google', 'baidu', 'douyin', 'xiaohongshu', 'bilibili', 'yandex', 'duckduckgo', 'weixin', ...AI_ENGINE_IDS],
    });
  });
  ...
  it('exports populated canonical Site Engine definitions and their dependent sources', async () => {
    ...
    await expect(buildExportPayload()).resolves.toMatchObject({
      ...
      sourceOrder: [site.id, 'bing', 'tavily', 'exa', 'brave', 'stepfun', 'stepfun-plan', 'jina', 'doubao', 'doubao-global', 'parallel', 'google', 'baidu', 'douyin', 'xiaohongshu', 'bilibili', 'yandex', 'duckduckgo', 'weixin', ...AI_ENGINE_IDS],
...
describe('parseImportPayload', () => {
  ...
  it('normalizes a valid partial sourceOrder by appending missing sources', () => {
    ...
    expect(result.ok).toBe(true);
    if (result.ok) expect(result.value.sourceOrder).toEqual(['bing', 'tavily', 'exa', 'brave', 'stepfun', 'stepfun-plan', 'jina', 'doubao', 'doubao-global', 'parallel', 'google', 'baidu', 'douyin', 'xiaohongshu', 'bilibili', 'yandex', 'duckduckgo', 'weixin', ...AI_ENGINE_IDS]);
  });
  ...
  it('accepts ai:* ids in sourceOrder and sourceHidden (regression: isKnownSource knows ai-engine ids)', () => {
    ...
    expect(result.value.sourceOrder).toEqual(['bing', 'ai:grok', 'tavily', 'ai:gemini', 'exa', 'brave', 'stepfun', 'stepfun-plan', 'jina', 'doubao', 'doubao-global', 'parallel', 'google', 'baidu', 'douyin', 'xiaohongshu', 'bilibili', 'yandex', 'duckduckgo', 'weixin', 'ai:chatgpt', 'ai:deepseek', 'ai:doubao']);
...
describe('mergeImport', () => {
  ...
  it('writes sourceOrder only when applying preferences', async () => {
    const payload = validPayload({ sourceOrder: ['bing', 'tavily', 'exa', 'brave', 'stepfun', 'stepfun-plan', 'jina', 'doubao', 'doubao-global', 'parallel', 'google', 'baidu', 'douyin', 'xiaohongshu', 'bilibili', 'yandex', 'duckduckgo', 'weixin', ...AI_ENGINE_IDS] });
  ...
  it('keeps a later source order move after an earlier import completes', async () => {
    ...
    const importedOrder: SourceId[] = ['bing', 'exa', 'google', 'tavily', 'brave', 'stepfun', 'stepfun-plan', 'baidu', 'douyin', 'xiaohongshu', 'bilibili', 'jina', 'doubao', 'doubao-global', 'parallel', 'yandex', 'duckduckgo', 'weixin', ...AI_ENGINE_IDS];
    const movedOrder: SourceId[] = ['exa', 'bing', 'google', 'tavily', 'brave', 'stepfun', 'stepfun-plan', 'baidu', 'douyin', 'xiaohongshu', 'bilibili', 'jina', 'doubao', 'doubao-global', 'parallel', 'yandex', 'duckduckgo', 'weixin', ...AI_ENGINE_IDS];
...
describe('previewImport (dry-run)', () => {
  ...
  it('includes Site Engine-only changes in the same preference confirmation diff', async () => {
    ...
    expect(preview.prefDiffs).toEqual(expect.arrayContaining([{
      ...
      key: 'sourceOrder',
      from: 'tavily > exa > brave > stepfun > stepfun-plan > jina > doubao > doubao-global > parallel > google > bing > baidu > douyin > xiaohongshu > bilibili > yandex > duckduckgo > weixin > ai:grok > ai:chatgpt > ai:deepseek > ai:doubao > ai:gemini > site:docs',
      to: 'tavily > exa > brave > stepfun > stepfun-plan > jina > doubao > doubao-global > parallel > google > bing > baidu > douyin > xiaohongshu > bilibili > yandex > duckduckgo > weixin > ai:grok > ai:chatgpt > ai:deepseek > ai:doubao > ai:gemini',
    }]));
  });
  ...
  it('reports a preference diff when only the normalized source order differs', async () => {
    ...
    expect(preview.prefDiffs).toEqual([{
      key: 'sourceOrder',
      from: 'bing > tavily > exa > stepfun > stepfun-plan > google > baidu > brave > jina > doubao > doubao-global > parallel > douyin > xiaohongshu > bilibili > yandex > duckduckgo > weixin > ai:grok > ai:chatgpt > ai:deepseek > ai:doubao > ai:gemini',
      to: 'tavily > exa > stepfun > stepfun-plan > google > bing > baidu > brave > jina > doubao > doubao-global > parallel > douyin > xiaohongshu > bilibili > yandex > duckduckgo > weixin > ai:grok > ai:chatgpt > ai:deepseek > ai:doubao > ai:gemini',
    }]);
  });
